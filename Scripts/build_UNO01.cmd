...
:BAGEN
D:\Development\Ardunio\arduino-1.6.11-windows\arduino-1.6.11\arduino.exe --board %BordName% --pref build.path=%BildDir% --preserve-temp-files --verbose-build --verify %InoPath%
pause
goto BAGEN
